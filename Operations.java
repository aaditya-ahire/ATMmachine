		...
		//------------------------------------------------
		 ...
		 if (str.equals("Balance")){
		        ...
		        try {
		            ...
		            // Add "Back" button to go back to operations window
		            JButton backBtn = new JButton("Back");
		            backBtn.setBounds(200, 400, 200, 50);
		            backBtn.setFont(new Font("Rockwell", Font.BOLD, 25));
		            frame.add(backBtn);
		            backBtn.addActionListener(new ActionListener() {
		                public void actionPerformed(ActionEvent e) {
		                    frame.dispose(); //dispose of the balance window
		                    try {
		                      //  opView("Operations", id);
		                    	h.homeView(id);//show operations window again
		                    } catch (SQLException e1) {
		                        e1.printStackTrace();
		                    }
		                }
